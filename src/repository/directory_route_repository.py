...
class DirectoryRouteRepository(IDirectoryRouteRepository):
    ...
    async def update(self, update_directory_route: DirectoryRoute) -> None:
        ...
        try:
            ...
            logger.error("Ошибка при обновлении справочника маршрутов с ID %d: %s", str(e), exc_info=True)
    ...
    async def delete(self, directory_route_id: int) -> None:
        ...
        try:
            ...
            logger.error("Ошибка при удалении справочника маршрутов с ID %d: %s", directory_route_id, e)
