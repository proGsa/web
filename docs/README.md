...
2. подбор возможных размещений и развлечений;
3. расчет общей стоимости путешествия;
4. просмотр архива путешествий;
5. просмотр ближайших мероприятий.
...
* *Тип приложения* - MPA, SPA  
* *backend* - Python, FastAPI, Pydantic, SQLAlchemy
* *frontend* - Python, HTML, CSS, Vue.js
* *database* - PostgreSQL  
